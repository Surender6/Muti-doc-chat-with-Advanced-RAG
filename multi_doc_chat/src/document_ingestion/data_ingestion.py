...
class ChatIngestor:
    def __init__(self,
        ...
        try:
            ...
            log.error("Failed to initialze Chat ingestor",error=str(e))
            raise DocumentPortalException("Initialize error in Chatingestor", e) from e
    
    def _resolve_dir(self,base: Path):
        if self.use_session:
            d = base / self.session_id ## e.g. "faiss_index/abc123"
            d.mkdir(parents=True,exist_ok=True) #creates directory if not exists
            return d
    ...
    def built_retriver(self,
        ...
        try:
            ...
            # faiss  manager very very important class for the  doc chat 
...
class FaissManager:
    def __init__(self,index_dir:Path,model_loader: Optional[ModelLoader]=None):
        ...
        self.meta_path=self.index_dir / "ingested_meta"
        self._meta:Dict[str,Any] = {"rows":{}} ## this is a dict of rows
